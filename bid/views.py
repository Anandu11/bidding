...
from bid.models import Listings, Bid, Comment
from bid.forms import ListingsForm, BidForm
...
def register(request):
    if request.method == "POST":
        ...
        if password != confirmation:
            return render(request, "bid/register.html", {
...
def login_view(request):
    if request.method == "POST":
        ...
        if user is not None:
            ...
            return render(request, "bid/login.html", {
...
def listingpage(request, listing_id, bidform=None):
    ...
    return render(request, "bid/listing.html", {
        'listing': listing,
...
def categories(request):
    ...
    print(categories)
    return render(request, "bid/categories.html", {
